...
> **Note:** `mafp5/` is a **separate, standalone Next.js/Cloudflare project**, not a workspace member. It is untracked in git and has its own `mafp5/AGENTS.md`. Do not treat it as part of this monorepo; scope changes to one or the other deliberately.
